# 英文版全站文案初稿（2026-08-09,Fable 譯自站主中文定稿,humanizer 紀律;待站主逐句審）

> 審法：直接在對話裡說「第 X 句改成…」或「OK」。設計性標籤（View series / Series · 001 / Next Series 等）本來就是英文,不在此列。中文直排「洪 立 楷 ／ 影 像 作 品」建議英文版保留原樣（美學元素,如同參考站保留日文）——要換再議。
...
## 系列 lede（首頁區塊）＋ subtitle（系列頁）

**Hasselblad**
- lede: For my two collaborations with Hasselblad, I wanted to push what the camera could do.
- subtitle:
> When I got my hands on a Hasselblad, I did not want to use it for just one thing. I wanted to see how it would answer to different subjects. This body of work covers portraits, street scenes, landscapes, and some more personal, more private views.
>
...
**可以一起做的事 → What we can do together**
...
**合作品牌 → Collaborations**（群組標籤）
- Camera brands / Architecture and business / Culture and art / Platforms
（品牌名本身不譯）

**展覽・出版・課程 → Exhibitions, publications and courses**
...
- 品牌合作與創作精選（精選磚副標）→ Selected collaborations and personal work

## 404
> Whoa, how did you end up here?! There is no such page.
> Back to home →

## DZ 說明行
> Works marked DEEP ZOOM can be opened and explored at full resolution.

## Meta（英文版 SEO）
- 首頁 title: Jerrythepopper | Taipei Photographer & 3D Artist | Portraits, Film & 3D Portfolio
- 首頁 description: Portfolio of Taipei photographer and 3D artist Jerry Hong (Jerrythepopper): portraits, street, film and nature photography alongside 3D visual work. Collaborations with Hasselblad, Leica and Sony. Based in Taipei, available worldwide.
- 3D 頁 title: 3D & CGI Visual Work | Jerrythepopper
- 3D 頁 description: Experiments on the border of photography and 3D: CGI scene design and mixed-reality visual work from Taipei.
