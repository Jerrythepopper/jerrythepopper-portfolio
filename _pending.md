...
| S24 | 深色模式 | **使用者 08-09 再點名,自 v2 提前**。**基調已裁：不死黑,用 HUD 色票庫的黑**——候選 #1f1d1a 暖墨黑（Fable 推薦,米白紙感的暗房版）/#16160e 暖橄欖黑/#2b2b2b 中性炭,待使用者從三選一;prefers-color-scheme 自動跟隨;完整深色系統（襯線重量/細線/毛玻璃重調） | S23 收工後,黑色三選一待答 |
